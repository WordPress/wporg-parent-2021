...
<div class="wp-block-group site-content-container has-white-color has-charcoal-2-background-color has-text-color has-background" style="border-top-color:var(--wp--preset--color--charcoal-1);border-top-width:1px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-style:none;border-left-width:0px;margin-top:0;padding-right:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:group {"textColor":"charcoal-1","className":"wporg-parent-oops-container","layout":{"type":"constrained"}} -->
...
<h1 class="has-heading-3-font-size"><?php esc_html_e( 'This page doesn\'t exist.', 'wporg' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:pattern {"slug":"wporg-parent-2021/404-page-subtitle"} /-->

<!-- wp:search {"showLabel":false,"placeholder":"Search...","width":100,"widthUnit":"%","buttonText":"Search","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"color":{"background":"#ffffff00"}},"textColor":"charcoal-1","className":"is-style-default"} /--></div>
<!-- /wp:group -->
